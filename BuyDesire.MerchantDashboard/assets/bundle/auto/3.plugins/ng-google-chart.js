(function (document, window, angular) {
    ...
    angular
        ...
        .provider('googleJsapiUrl', googleJsapiUrl)
        .factory('googleChartApiPromise', googleChartApiPromise)
    ...
    googleChartApiPromise.$inject = ['$rootScope', '$q', 'googleChartApiConfig', 'googleJsapiUrl'];
    function googleChartApiPromise($rootScope, $q, apiConfig, googleJsapiUrl) {
    ...
    googleChart.$inject = ['$timeout', '$window', '$rootScope', 'googleChartApiPromise'];
    function googleChart($timeout, $window, $rootScope, googleChartApiPromise) {
        return {
            restrict: 'A',
            scope: {
                beforeDraw: '&',
