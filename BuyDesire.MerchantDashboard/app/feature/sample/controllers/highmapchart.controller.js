(function () {
    'use strict';
    var controllerID = 'highmapchartController';
    angular
        .module('app')
        .controller(controllerID, highmapchartController);

    highmapchartController.$inject = ['utils', '_', 'uiHelper', 'config'];
    function highmapchartController(utils, _, uiHelper, config) {
        var vm = this;
        init();
